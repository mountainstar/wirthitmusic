        ...
        <>
            ...
            <Box id="about" sx={{ padding: '20px' }}>
                ...
                <Typography variant="body1">
                    ...
                    and only five made it out. Now we took an oath, that I'm breaking now. We said we'd say it was the snow that killed the other two, but it wasn't. Nature is lethal but it doesn't hold a candle to man.
                </Typography>
            </Box>
            <Divider />
